...
/// <summary>Builds the <see cref="DateRangePicker"/> theme: an optional label over an outlined box (<c>PART_Box</c>) showing the selected range (<c>PART_Display</c>) and a calendar icon.</summary>
