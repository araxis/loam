...
| Gallery and docs | Gallery, docs site | In progress | Design-system page shows foundations; gallery acceptance now includes source-linked samples plus expanded shell, overlay, snackbar/dialog, popover, and static feedback examples. |
